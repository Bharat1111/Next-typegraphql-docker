...
let UserResolver = class UserResolver {
    changePassword(token, newPassword, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userId = yield redis_1.redis.get(key);
            if (!userId) {
                return {
                    errors: [
                        {
            ...
            const user = yield User_1.Users.findOne(userID);
            if (!user) {
                return {
                    errors: [
                        {
            ...
            yield User_1.Users.update({ id: userID }, {
    ...
    forgotPassword(email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis_1.redis.set(constants_1.FORGOT_PASSWORD_PREFIX + token, user.id, "ex", 1000 * 60 * 60 * 24 * 3);
